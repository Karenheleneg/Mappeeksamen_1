...
```{r, echo=FALSE, message=FALSE, warning=FALSE, include=TRUE, results='hide', fig.cap= "Figuren viser resultater maksimalt oksygenopptak (VO2maks) test fra test 1 og 2"}
library(tidyverse)
library(readxl)
